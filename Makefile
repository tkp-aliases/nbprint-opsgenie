...
lint-py:  ## lint python with ruff
	python -m ruff check nbprint_opsgenie
	python -m ruff format --check nbprint_opsgenie
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix nbprint_opsgenie
	python -m ruff format nbprint_opsgenie
...
test:  ## run python tests
	python -m pytest -v nbprint_opsgenie/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v nbprint_opsgenie/tests --cov=nbprint_opsgenie --cov-report term-missing --cov-report xml
